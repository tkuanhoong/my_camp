...
class CampsiteRepository {
  ...
  Future<List<Campsite>> getCampsiteList(List<Campsite> campsitesList,
      String? keyword, List? selectedStates, String? userId) async {
    return campsiteService.fetchCampsiteData(
  ...
  Future<Campsite?> fetchSingleCampsiteData(
      String campsiteId, String? userId) async {
    return campsiteService.fetchSingleCampsiteData(campsiteId);
  }

  Future<bool> verifyCampsiteOwner(userId, campsiteId) async {
    return campsiteService.verifyCampsiteOwner(userId, campsiteId);
  }
